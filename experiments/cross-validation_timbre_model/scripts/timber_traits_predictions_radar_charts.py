...
def plot_radar_chart(embedding_type: str, hidden_layer_suffix: str, save_folder: str, verbose: bool = False):
    """
    Plot and save a radar chart comparing ground truth and predicted timber trait values for each instrument.
    ...
    This function:
    1. Loads ground truth timber trait values and predicted values.
    ...
    # Select relevant columns: Instrument and timber traits
    ...
    for instrument in tqdm(instruments_names, desc=f"Computing radar charts for model trained on {embedding_type} with {hidden_layer_suffix}"):
        ...
        # Compute 95% confidence intervals of human ratings for each timber trait
